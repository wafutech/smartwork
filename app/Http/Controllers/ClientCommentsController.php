...
class ClientCommentsController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('comments.client.index',array('title'=>'Client Comments','comments'=>$clientComments));
    }
    ...
    public function store(Request $request)
    {
     ...
     if($validator->fails()) {
      ...
      $input =$request->all();
        $create = ClientComment::create($input);
    ...
    {
        $input = $request->all();
        $comment = ClientComment::findOrFail($id)->update($input);
    ...
    public function destroy($id)
    {
        ...
        $comment->delete();
        return response('Commented deleted');
    }
}
